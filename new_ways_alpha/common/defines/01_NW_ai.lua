...
-- NDefines.NAI.GARRISON_FRACTION = 0.2										-- How large part of a front should always be holding the line rather than advancing at the enemy				TODO in new ai defines
...
-- NDefines.NAI.UNIT_ASSIGNMENT_TERRAIN_IMPORTANCE = 20.0						-- diminshed by 4x because of Greece-- Terrain score for units are multiplied by this when the AI is deciding which front they should be assigned to				TODO in new ai defines
-- NDefines.NAI.RESEARCH_AHEAD_OF_TIME_FACTOR = 15.0							-- To which extent AI should care about ahead of time penalties to research	#4.0				TODO in new ai defines
--NDefines.NAI.VARIANT_UPGRADE_MIN_XP = 100									-- Minimum XP before attempting to create a new variant. #50
-- NDefines.NAI.RESEARCH_BONUS_FACTOR = 1.5									-- To which extent AI should care about bonuses to research				TODO in new ai defines
-- NDefines.NAI.MAX_AHEAD_RESEARCH_PENALTY = 10								-- max ahead of tiem penalty ai will pick ever				TODO in new ai defines
...
-- NDefines.NAI.UPGRADE_DIVISION_RELUCTANCE = 7								-- How often to consider upgrading to new templates for units in the field				TODO in new ai defines
-- NDefines.NAI.UPGRADE_PERCENTAGE_OF_FORCES = 0.01							-- How big part of the army that should be considered for upgrading				TODO in new ai defines
-- NDefines.NAI.UPGRADES_DEFICIT_LIMIT_DAYS = 180		--365				-- Ai will avoid upgrading units in the field to new templates if it takes longer than this to fullfill their equipment need				TODO in new ai defines
...
-- NDefines.NAI.MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.7	--0.6				-- Cancel unit production if below this to get resources out to units in the field				TODO in new ai defines
-- NDefines.NAI.MIN_MANPOWER_TO_BUILD_UNITS = 0.7			--0.6				-- Cancel unit production if below this to get resources out to units in the field				TODO in new ai defines
...
-- NDefines.NAI.DIVISION_DESIGN_COMBAT_WIDTH_TARGET_WEIGHT = -10000			-- This score is reduced the farther the width is from the target width (if set)				TODO in new ai defines
...
-- DIVISION PRODUCTION
-- NDefines.NAI.DEPLOY_MIN_TRAINING_SURRENDER_FACTOR = 0.5						-- Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime while surrender progress is higher than 0 				TODO in new ai defines
-- NDefines.NAI.DEPLOY_MIN_EQUIPMENT_SURRENDER_FACTOR = 0.8					-- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime while surrender progress is higher than 0 				TODO in new ai defines
-- NDefines.NAI.DEPLOY_MIN_TRAINING_PEACE_FACTOR = 0.4							-- Required percentage of training (1.0 = 100%) for AI to deploy unit in peacetime				TODO in new ai defines
-- NDefines.NAI.DEPLOY_MIN_EQUIPMENT_PEACE_FACTOR = 0.9						-- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in peacetime				TODO in new ai defines
-- NDefines.NAI.DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.9		--0.05				-- Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime				TODO in new ai defines
-- NDefines.NAI.DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.9		--0.8				-- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime				TODO in new ai defines
-- NDefines.NAI.DEPLOY_MIN_EQUIPMENT_CAP_DEPLOY_FACTOR = 0.85					-- If training is capped by equipment deficit and we have reached that cap, deploy unit anyway if percentage is above this (reinforce in field instead).				TODO in new ai defines

-- EQUIPMENT PRODUCTION
-- NDefines.NAI.PRODUCTION_EQUIPMENT_SURPLUS_FACTOR = 1	-- 0.4				-- Base value for how much of currently used equipment the AI will at least strive to have in stock				TODO in new ai defines
...
-- NDefines.NAI.ASSIGN_TANKS_TO_WAR_FRONT = 8.0		--4.0					-- Scoring factor for assigning tank divisions to active war fronts				TODO in new ai defines
...
-- NDefines.NAI.START_TRAINING_EQUIPMENT_LEVEL = 0.8							-- ai will not start to train if equipment drops below this level				TODO in new ai defines
-- NDefines.NAI.STOP_TRAINING_EQUIPMENT_LEVEL = 0.7							-- ai will not train if equipment drops below this level				TODO in new ai defines
...
-- NDefines.NAI.PLAN_ACTIVATION_MAJOR_WEIGHT_FACTOR = 1						-- AI countries will hold on activating plans if stronger countries have plans in the same location. Majors count extra (value of 1 will negate this)				TODO in new ai defines
-- NDefines.NAI.PLAN_ACTIVATION_PLAYER_WEIGHT_FACTOR = 1						-- AI countries will hold on activating plans if player controlled countries have plans in the same location. Majors count extra (value of 1 will negate this)				TODO in new ai defines
...
-- NDefines.NAI.MIN_AI_SCORE_TO_ECONOMY_LAW_OVERRIDE_HARD_CODED_SCORE = 1000.0				TODO in new ai defines
...
-- NDefines.NAI.DEFAULT_MODULE_VARIANT_CREATION_XP_CUTOFF_LAND = 50 --50		-- Army XP needed before attempting to create a variant of a type that uses the tank designer (the tank designer DLC feature must be active).				TODO in new ai defines
-- NDefines.NAI.DEFAULT_MODULE_VARIANT_CREATION_XP_CUTOFF_NAVY = 25 --50		-- Same as above but for the ship designer.				TODO in new ai defines
-- NDefines.NAI.DEFAULT_MODULE_VARIANT_CREATION_XP_CUTOFF_AIR = 25 --25		-- Same as above but for the air designer.				TODO in new ai defines

-- NDefines.NAI.VARIANT_CREATION_XP_RESERVE_LAND = 50 --50						-- If the AI lacks army XP to create a variant it will reserve this much XP for variant creation so that it will eventually be able to create a variant.				TODO in new ai defines
-- NDefines.NAI.VARIANT_CREATION_XP_RESERVE_NAVY = 50 --50						-- Same as above but for navy XP.				TODO in new ai defines
-- NDefines.NAI.VARIANT_CREATION_XP_RESERVE_AIR  = 50 --50						-- Same as above but for air XP.				TODO in new ai defines
...
-- NDefines.NAI.LAND_DESIGN_ALTERNATIVE_ABSENT = 1 --1000000				TODO in new ai defines
-- NDefines.NAI.LAND_DESIGN_ALTERNATIVE_OF_LESSER_TECH = 1 --10000				TODO in new ai defines
-- NDefines.NAI.LAND_DESIGN_ALTERNATIVE_OF_EQUAL_TECH = 1 --100				TODO in new ai defines
-- NDefines.NAI.LAND_DESIGN_ALTERNATIVE_OF_GREATER_TECH = 1				TODO in new ai defines
...
-- NDefines.NAI.LAND_DESIGN_DEMAND_FIELD_DIVISION = 50			--20				TODO in new ai defines
-- NDefines.NAI.LAND_DESIGN_DEMAND_TRAINING_DIVISION = 50		--15				TODO in new ai defines
-- NDefines.NAI.LAND_DESIGN_DEMAND_GARRISON_DIVISION = 10		--10				TODO in new ai defines
-- NDefines.NAI.LAND_DESIGN_DEMAND_UNUSED_TEMPLATE = 10		--1				TODO in new ai defines
-- NDefines.NAI.LAND_DESIGN_DEMAND_ABSENT = 10					--0				TODO in new ai defines
...
-- NDefines.NAI.LAND_DESIGN_CUTOFF_AS_PERCENTAGE_OF_MAX = 0.01		--0.25				TODO in new ai defines
...
-- NDefines.NAI.DESIRE_USE_XP_TO_UNLOCK_LAND_DOCTRINE = 1    -- How quickly is desire to unlock land doctrines accumulated?				TODO in new ai defines
-- NDefines.NAI.DESIRE_USE_XP_TO_UNLOCK_NAVAL_DOCTRINE = 1   -- How quickly is desire to unlock naval doctrines accumulated?				TODO in new ai defines
-- NDefines.NAI.DESIRE_USE_XP_TO_UNLOCK_AIR_DOCTRINE = 1     -- How quickly is desire to unlock air doctrines accumulated?				TODO in new ai defines
...
-- NDefines.NAI.DESIRE_USE_XP_TO_UPDATE_LAND_TEMPLATE = 100.0 --2.0    -- How quickly is desire to update/create templates accumulated?				TODO in new ai defines

-- NDefines.NAI.DESIRE_USE_XP_TO_UPGRADE_LAND_EQUIPMENT = 2.0		-- How quickly is desire to update/create land equipment variants accumulated?				TODO in new ai defines
-- NDefines.NAI.DESIRE_USE_XP_TO_UPGRADE_NAVAL_EQUIPMENT = 100.0	-- How quickly is desire to update/create naval equipment variants accumulated?				TODO in new ai defines
-- NDefines.NAI.DESIRE_USE_XP_TO_UPGRADE_AIR_EQUIPMENT = 100.0		-- How quickly is desire to update/create air equipment variants accumulated?				TODO in new ai defines

-- NDefines.NAI.DESIRE_USE_XP_TO_UNLOCK_ARMY_SPIRIT = 0.4			-- How quickly is desire to unlock army spirits accumulated?				TODO in new ai defines
-- NDefines.NAI.DESIRE_USE_XP_TO_UNLOCK_NAVY_SPIRIT = 0.4			-- How quickly is desire to unlock naval spirits accumulated?				TODO in new ai defines
-- NDefines.NAI.DESIRE_USE_XP_TO_UNLOCK_AIR_SPIRIT = 0.4			-- How quickly is desire to unlock air spirits accumulated?				TODO in new ai defines

-- NDefines.NAI.DAYS_BETWEEN_CHECK_BEST_DOCTRINE = 7				-- Recalculate desired best doctrine to unlock with this many days inbetween.				TODO in new ai defines
-- NDefines.NAI.DAYS_BETWEEN_CHECK_BEST_TEMPLATE = 7				-- Recalculate desired best template to upgrade with this many days inbetween.				TODO in new ai defines
-- NDefines.NAI.DAYS_BETWEEN_CHECK_BEST_EQUIPMENT = 7				-- Recalculate desired best equipment to upgrade with this many days inbetween.				TODO in new ai defines

-- NDefines.NAI.GARRISON_TEMPLATE_SCORE_IC_FACTOR = 1.0			-- ai uses these defines while calculating garrison template score of a template.				TODO in new ai defines
-- NDefines.NAI.GARRISON_TEMPLATE_SCORE_MANPOWER_FACTOR = 0.05		-- formula is (template_ic * ic_factor + template_manpower * manpower_factor ) / template_supression (lower is better)				TODO in new ai defines
...
-- NDefines.NAI.DIVISION_DESIGN_MANPOWER_WEIGHT = 0 --0.005				TODO in new ai defines
-- NDefines.NAI.DIVISION_DESIGN_STOCKPILE_WEIGHT = 0 --0.01				TODO in new ai defines

--------------
-- NAVY
--------------

-- NDefines.NAI.MAX_SCREEN_TASKFORCES_FOR_MINE_SWEEPING = 0.10					-- maximum ratio of screens forces to be used in mine sweeping				TODO in new ai defines
-- NDefines.NAI.MAX_SCREEN_TASKFORCES_FOR_MINE_SWEEPING_PRIO_MAX_MINES = 250	-- highest mines for highest prio for mine missions				TODO in new ai defines
-- NDefines.NAI.MAX_SCREEN_TASKFORCES_FOR_MINE_LAYING = 0.05					-- maximum ratio of screens forces to be used in mine laying				TODO in new ai defines
...
-- NDefines.NAI.MIN_NAVAL_MISSION_PRIO_TO_ASSIGN = {  -- priorities for regions to get assigned to a mission				TODO in new ai defines
...
-- NDefines.NAI.HIGH_PRIO_NAVAL_MISSION_SCORES = {  -- priorities for regions to get assigned to a mission				TODO in new ai defines
	-- 0, -- HOLD (consumes fuel HOLD_MISSION_MOVEMENT_COST fuel while moving)
	-- 3800, -- PATROL - 100000
	-- 1000, -- STRIKE FORCE 
	-- 1500, -- CONVOY RAIDING
...
-- NDefines.NAI.MAX_MISSION_PER_TASKFORCE = {  -- max mission region/taskforce ratio				TODO in new ai defines
	-- 0, -- HOLD (consumes fuel HOLD_MISSION_MOVEMENT_COST fuel while moving)
	-- 1.5, -- PATROL		
	-- 6, -- STRIKE FORCE 
	-- 1.5, -- CONVOY RAIDING
...
-- NDefines.NAI.MAX_SCREEN_TASKFORCES_FOR_CONVOY_DEFENSE_MIN = 0.40 			-- maximum ratio of all screen-ships forces to be used in convoy defense (increases up to max as AI loses convoys).				TODO in new ai defines
-- NDefines.NAI.MAX_SCREEN_TASKFORCES_FOR_CONVOY_DEFENSE_MAX = 0.6 			-- maximum ratio of all screen-ships forces to be used in convoy defense (increases up to max as AI loses convoys).				TODO in new ai defines
-- NDefines.NAI.MAX_SCREEN_TASKFORCES_FOR_CONVOY_DEFENSE_MAX_CONVOY_THREAT = 500	-- AI will increase screen assignment for escort missions as threate increases				TODO in new ai defines
